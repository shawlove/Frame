...
public static class ExampleConfig
{
    ...
    public static IEnumerable<Type> LuaCallCSharp
    {
        get
        {
            ...
            string[] customAssemblys = { }; //new string[] {"Assembly-CSharp",};
    ...
    //         var          allAssemblys = new Assembly[] {Assembly.Load("Assembly-CSharp")};
    ...
    //         var paramTypes = allMethods.SelectMany(m => m.GetParameters())
    ...
    //         return (returnTypes.Concat(paramTypes).Concat(fieldTypes)).Where(t => t.BaseType == typeof(MulticastDelegate) && !hasGenericParameter(t) && !delegateHasEditorRef(t))
    //                                                                   .Distinct();
    //     }
    // }
    //
